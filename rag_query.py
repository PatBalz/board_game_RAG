...
Please keep your answer as concicse as possible and do not repeat yourself! 
Keep in mind that the context provided above based on the fragments was generated by a RAG system, not by user input.
The only user input was: {question}
"""


question = "how many victory points does one player need to reach in order to win the game?"#"""what happens when I send an Agent to Conspire board space and what do I gain?"""
